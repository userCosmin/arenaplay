  ...
  return (
    <>
      ...
      <Section className="bg-white">
        <h2 className="mb-10 font-display text-display-md font-extrabold text-ink-900">6 activități, un singur loc</h2>
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {activities.map((activity) => (
            ...
            >
              ...
              <h3 className="mt-1 font-display text-lg font-bold text-ink-900">{activity.name}</h3>
      ...
      <Section className="bg-playground-navy">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-display font-bold text-white">Program</h3>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-display font-bold text-white">Tarife &amp; oferte</h3>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-display font-bold text-white">Rezervare simplă</h3>
